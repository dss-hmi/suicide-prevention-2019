...
```{r g0, echo=FALSE, results='show', message=FALSE, warning = F}
```

## Population Counts
```{r g1, echo=FALSE, results='show', message=FALSE, warning = F, fig.width = 17, fig.height = 11,out.width = "960px"}
```

## Suicides Counts
```{r g2, echo=FALSE, results='show', message=FALSE, warning = F, fig.width = 17, fig.height = 11,out.width = "960px"}
```
