...
read_chunk("./analysis/population-estimates/population-estimates.R") 
```
...
```{r g1a, echo=TRUE, fig.height=7, fig.width=12,out.width= "400px", message=FALSE, results='show'}
g1
```



```{r g1b, echo=TRUE, fig.height=7, fig.width=12,out.width= "900px" ,results='show', message=FALSE}
g1
```
