...
## Data Tweaks
This dataset already comes  well-gromed, so only some minor housekeeping tweaks are necessary to make graphing more convenient. The data is also filter to only include ages 10-24.
...
> What is the overall trajectory of youth suicides in FL between 2006 and 2017? 
...
```{r rate-cause-race, echo=TRUE, fig.height=5, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
