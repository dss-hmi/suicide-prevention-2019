...
```{r overall-trends, echo=TRUE, fig.height=6, fig.width=9, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```

> Q1b - How do trends in population growth, suicide count and suicide rate compare among age group? 

```{r age-breakdown, echo=TRUE, fig.height=7, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r age-breakdown-2, echo=TRUE, fig.height=3, fig.width=8, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r age-breakdown-3, echo=TRUE, fig.height=5, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r age-breakdown-4, echo=TRUE, fig.height=7, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r g5, echo=TRUE, fig.height=5, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```

```{r g6, echo=TRUE, fig.height=5, fig.width=10, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
