...
This document is the annotation layer to [`./manipulation/9-combiner.R`][path_combiner] script, which prepares a single flat data frame by combining data products of `greeter` scripts:  
- [`./manipulation/0-greeter-gls.R`][path_greeter_0] GLS programming   
- [`./manipulation/1-greeter-population.R`][path_greeter_1] Population Estimates  
- [`./manipulation/2-greeter-suicide.R`][path_greeter_2] Death Counts   

The data frame produced by this report is the starting point for all subsequent analytic activity in the project. Any new additions **must be** incorportated into this producted and integrated in the `./manipulation` workflow.
