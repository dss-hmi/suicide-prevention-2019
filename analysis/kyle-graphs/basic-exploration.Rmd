...
# there has to be an easier way to get the SLOPE!!!!!!!!!!!!!!!
...
gghighlight and gganimate don't seem to work well together.  could possible subset a different way to get the overlap, more to come

```{r}
# g3a <- g3 + transition_time(year) 
# 
# g3a
```
