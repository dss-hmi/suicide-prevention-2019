...
# ds_sex %>% readr::write_csv("./data-unshared/derived/tallahassee/12_18/age12_18-sex.csv")
# ds_sex_race %>% readr::write_csv("./data-unshared/derived/tallahassee/12_18/age12_18-sex-race.csv")
...
rates_10_24 <- readr::read_csv("./data-unshared/raw/tallahassee/10_24/population_rates-mortality_causes(all)-ages10_24.csv")
