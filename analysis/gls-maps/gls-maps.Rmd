...
```{r expo-1 , echo=echoChunks, results='show', message=FALSE,warning=warningChunks, fig.width = 17, fig.height = 7, out.width = "960px"} 
```

```{r expo-2 , echo=echoChunks, results='show', message=FALSE,warning=warningChunks, fig.width = 17, fig.height = 7, out.width = "960px"} 
```
