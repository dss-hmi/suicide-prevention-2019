...
```{r g41, echo=TRUE, fig.height=9, fig.width=12, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r g42, echo=TRUE, fig.height=9, fig.width=12, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r g51, echo=TRUE, fig.height=11, fig.width=15, out.width = "900px", message=FALSE, results='show',cache=TRUE}
```
...
```{r g52, echo=TRUE, fig.height=9, fig.width=23, out.width = "1200px", message=FALSE, results='asis',cache=TRUE}
```
session information
===========================================================================
